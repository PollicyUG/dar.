...
from answer_policy_question import process_question, get_DOAJ_articles, get_Crossref_articles,\
									get_CORE_articles, answer_question
...
def returnanswer():
	...
	try:
		summary_consequence = wikipedia.summary(request.json['replies']['phenomenon'])
	except (DisambiguationError, HTTPTimeOutError, PageError, RedirectError):
		summary_consequence = ''
		
	return render_template('answer.html', question=question, answer=answer, summary_policy=summary_policy, \
